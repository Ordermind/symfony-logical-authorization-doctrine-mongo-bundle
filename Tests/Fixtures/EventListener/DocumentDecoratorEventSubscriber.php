...
class DocumentDecoratorEventSubscriber implements EventSubscriberInterface {
  public static function getSubscribedEvents() {
    return array(
      'ordermind_logical_authorization_doctrine_mongo.event.document_decorator.before_method_call' => array(
        array('onBeforeMethodCall'),
      ),
      'ordermind_logical_authorization_doctrine_mongo.event.document_decorator.before_save' => array(
        array('onBeforeSave'),
      ),
      'ordermind_logical_authorization_doctrine_mongo.event.document_decorator.before_delete' => array(
