...
/**
 * TestDocumentAbortCalls
 *
 * @ODM\Document(repositoryClass="Ordermind\LogicalAuthorizationDoctrineMongoBundle\Tests\Fixtures\Repository\Misc\TestDocumentAbortCallsRepository")
 */
class TestDocumentAbortCalls
{
    /**
     * @var int
     *
