...
/**
 * TestDocumentConstructorParams
 *
 * @ODM\Document(repositoryClass="Ordermind\LogicalAuthorizationDoctrineMongoBundle\Tests\Fixtures\Repository\Misc\TestDocumentConstructorParamsRepository")
 */
class TestDocumentConstructorParams
{
    /**
     * @var int
     *
