...
/**
 * TestDocumentAbortCreate
 *
 * @ODM\Document(repositoryClass="Ordermind\LogicalAuthorizationDoctrineMongoBundle\Tests\Fixtures\Repository\Misc\TestDocumentAbortCreateRepository")
 */
class TestDocumentAbortCreate
{
    /**
     * @var int
     *
